...
// str= "bananab" //→ { b:1, a:3, n:2 }
// let o = {}
// for(let i=0;i<str.length;i++){
//     // if(o[i].hasOwnProperty(str[i])){
//     if(str[i] in o){
//         o[str[i]]++;
//     }
//     else{
...
// let str1 =  "I love programming in JavaScript";
